...
- The feature can be turned on or off per user.
- Per default the feature is switched off.
- An ordinary user can not turn the feature on or off, only an administrator can do so.
