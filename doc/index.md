...
| [design-input/domain/billing-plans-and-entitlements.md](design-input/domain/billing-plans-and-entitlements.md) | Proposed billing foundation: Private Access, Free Trial, Starter/Business, versioned plan limits, usage events, Stripe subscriptions, and admin controls |
